...
TERMUX_PKG_DEPENDS="graphviz, kf6-kconfig, kf6-kconfigwidgets, kf6-kcoreaddons, kf6-ki18n, kf6-kparts, kf6-kwidgetsaddons, kf6-kxmlgui, libc++, qt6-qt5compat, qt6-qtbase, qt6-qtsvg"
